...
/* themes/contrib/bootstrap5_admin/templates/views/views-mini-pager.html.twig */
class __TwigTemplate_3bf041ac7de4a2fa46da4f205f6201d7 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <ul class=\"pagination justify-content-center\">
      ...
      ";
          ...
          ";
                // line 27
                echo t("<a class=\"page-link\">Page @items.current</a>", array("@items.current" => twig_get_attribute($this->env, $this->source,                 // line 28
...
";
    ...
    {
        return "themes/contrib/bootstrap5_admin/templates/views/views-mini-pager.html.twig";
    }
    ...
    <ul class=\"pagination justify-content-center\">
      ...
      {% if items.current %}
        <li class=\"page-item active\">
          {% trans %}
            <a class=\"page-link\">Page {{ items.current }}</a>
          {% endtrans %}
        </li>
      {% endif %}
      {% if items.next %}
...
{% endif %}
", "themes/contrib/bootstrap5_admin/templates/views/views-mini-pager.html.twig", "/var/www/duculaba/web/themes/contrib/bootstrap5_admin/templates/views/views-mini-pager.html.twig");
    }
