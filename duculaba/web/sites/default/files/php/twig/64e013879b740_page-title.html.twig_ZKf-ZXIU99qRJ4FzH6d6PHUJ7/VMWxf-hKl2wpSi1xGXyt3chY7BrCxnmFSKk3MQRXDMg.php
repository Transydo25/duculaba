...
/* themes/contrib/bootstrap5_admin/templates/content/page-title.html.twig */
class __TwigTemplate_3f270a94bbb0833b30abcfcf840d00af extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (twig_trim_filter(twig_striptags($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(($context["title"] ?? null))))) {
            // line 17
            echo "  <h1";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", [0 => [0 => "display-4", 1 => "page-title"]], "method", false, false, true, 17), 17, $this->source), "html", null, true);
            echo ">";
...
";
    ...
    {
        return "themes/contrib/bootstrap5_admin/templates/content/page-title.html.twig";
    }
...
{% if title|render|striptags|trim %}
  <h1{{ title_attributes.addClass(['display-4', 'page-title']) }}>{{ title }}</h1>
{% endif %}
{{ title_suffix }}
", "themes/contrib/bootstrap5_admin/templates/content/page-title.html.twig", "/var/www/duculaba/web/themes/contrib/bootstrap5_admin/templates/content/page-title.html.twig");
    }
