...
class __TwigTemplate_4dfc414986759343eddb515261193f11 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("{# inline_template_start #}<div class=\"block-filter-text-source\">{{ label }}</div>", "__string_template__bb2a178ab58e514511be9abae6d47254", "");
    }
